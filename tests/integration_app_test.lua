...
T.test("Cover APP information routes through versions and safe GitHub links",function()
    ...
    T.equal(view.actions.version,"2.3.8")
    view.actions.info()
    T.equal(app.screen,"appInfo"); T.equal(view.model.items[1].version,"2.3.8")
    ...
    view.actions.next(); T.equal(view.model.items[1].version,"2.3.7")
    app:onResume(); T.equal(view.screen,"appInfo"); T.equal(view.model.items[1].version,"2.3.7")
    view.actions.previous(); T.equal(view.model.items[1].version,"2.3.8")
